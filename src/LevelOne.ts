...
export class LevelOne extends GameScene {
  ...
  private setupLevel() {
    ...
    this.createCube(15, 0, new THREE.Vector3(0, -1, 0), 0x888888);

    // Falling Box
    this.createCube(1, 1, new THREE.Vector3(0, 5, 0), 0xff0000);

    // Another Box slightly offset
    this.createCube(1, 1, new THREE.Vector3(0.5, 8, 0), 0x00ff00);
  }
}
